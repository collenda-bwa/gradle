...
`org.gradle.welcome-message=(true,false)`::
When set to `false`, Gradle won't generate welcome message.
_Enabled by default and welcome message is shown on first execution of each new version of Gradle._
